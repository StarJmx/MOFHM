...
# 加载数据
# ============================================================================
data = pd.read_excel(r"data/final_dataset.xlsx", sheet_name='Sheet_Q')
...
# 加载模型
# ============================================================================
with open('pkl/MOFsCrPbCdAs_XGB_Q.pkl', 'rb') as f:
    model = pickle.load(f)
    print('load success!')
...
# ----------------------------------------------------------------------------
time_Q = pd.read_excel(r"data/final_dataset.xlsx", sheet_name='Sheet_Q_shap')
feature_names = time_Q.columns
print(feature_names)
time_Q = np.array(time_Q)
print(time_Q.shape)
time_Q_x = time_Q[:, :-1]
time_Q_y = time_Q[:, -1]
print(time_Q_x.shape)
print(time_Q_y.shape)
config = {
...
index_order = list(range(len(time_Q_x)))
print(index_order)
explainer = shap.Explainer(model, time_Q_x, feature_names=feature_names)
shap_values_time_Q = explainer(time_Q_x)
shap.plots.heatmap(shap_values_time_Q, max_display=14)
mp.gcf().set_size_inches(5, 4)
mp.colorbar(location='right')
mp.title('(a)MQ', fontsize=14)
mp.show()
...
ax1.set_title('(a)MQ', fontsize=14)
...
mp.rcParams['ytick.direction'] = 'in'
fig = mp.figure(figsize=(7, 7))
grid = mp.GridSpec(3, 2, hspace=0.7, wspace=0.35)
ax1 = fig.add_subplot(grid[0, 0])
shap.dependence_plot("OL", shap_values1, Cr_x, interaction_index='CI', feature_names=feature_names, show=False, display_features=Cr_X_display, ax=ax1)
ax1.set_title('(a1)Cr', fontsize=14)
ax1.tick_params(axis='x', labelsize=7)
ax2 = fig.add_subplot(grid[0, 1])
shap.dependence_plot("OL", shap_values1, Cr_x, interaction_index='AD', feature_names=feature_names, show=False, display_features=Cr_X_display, ax=ax2)
ax2.set_title('(a2)Cr', fontsize=14)
ax2.tick_params(axis='x', labelsize=7)
ax3 = fig.add_subplot(grid[1, 0])
shap.dependence_plot("OL", shap_values2, Pb_x, interaction_index='CI', feature_names=feature_names, show=False, display_features=Pb_X_display, ax=ax3)
ax3.set_title('(b1)Pb', fontsize=14)
ax3.tick_params(axis='x', labelsize=7)
ax4 = fig.add_subplot(grid[1, 1])
shap.dependence_plot("OL", shap_values2, Pb_x, interaction_index='AD', feature_names=feature_names, show=False, display_features=Pb_X_display, ax=ax4)
ax4.set_title('(b2)Pb', fontsize=14)
ax4.tick_params(axis='x', labelsize=7)
ax5 = fig.add_subplot(grid[2, 0])
shap.dependence_plot("OL", shap_values3, Cd_x, interaction_index='AD', feature_names=feature_names, show=False, display_features=Cd_X_display, ax=ax5)
ax5.set_title('(c)Cd', fontsize=14)
ax5.tick_params(axis='x', labelsize=7)
ax6 = fig.add_subplot(grid[2, 1])
shap.dependence_plot("OL", shap_values4, As_x, interaction_index='AD', feature_names=feature_names, show=False, display_features=As_X_display, ax=ax6)
ax6.set_title('(d)As', fontsize=14)
ax6.tick_params(axis='x', labelsize=7)
mp.subplots_adjust(top=0.95, bottom=0.1, left=0.1, right=0.95)
mp.tight_layout()
mp.show()
...
ax2.set_title('(b)Cr', fontsize=14)
...
ax3.set_title('(c)Cr', fontsize=14)
...
ax4.set_title('(d)Pb', fontsize=14)
...
ax5.set_title('(e)Pb', fontsize=14)
...
ax6.set_title('(f)Pb', fontsize=14)
ax6.set_xlim(0, 1.5)
...
ax1.set_title('(g)Cd', fontsize=14)
...
ax2.set_title('(h)Cd', fontsize=14)
ax2.set_xlim(0, 15)
...
ax3.set_title('(i)Cd', fontsize=14)
...
ax4.set_title('(j)As', fontsize=14)
ax4.set_xlim(0, 1800)
ax4.set_ylim(-20, 20)
...
ax5.set_title('(k)As', fontsize=14)
ax5.set_ylim(-30, 30)
...
ax6.set_title('(l)As', fontsize=14)
...
# ============================================================================
# Single sample explanatory diagram of MQ_Cd: CaFu MOF
# ============================================================================
data = pd.read_excel(r"data/final_dataset.xlsx", sheet_name='Sheet_Q')
feature_names = data.columns
...
mp.rcParams['xtick.direction'] = 'in'
mp.rcParams['ytick.direction'] = 'in'
shap.force_plot(shap_values_CaFu[2664, :], features=X_display.iloc[2664, :], link="identity", matplotlib=True, show=False)  # 若需定性变量显示未编码的值，可解决！
mp.title('Actual Q of CaFu MOF:690.11', fontsize=14, loc='left')
mp.subplots_adjust(top=0.94, bottom=0.1, left=0.14, right=0.95)
mp.tight_layout()
mp.show()
